...
```{r dim5, include=TRUE, fig.cap='A barplot of the average percent Correct and Incorrect responses for Female and Male participants - using geom_bar()'}
total_n_trials <- 96
...
```{r dim6, include=TRUE, fig.cap='A barplot of the average percent Correct and Incorrect responses for Female and Male participants - using geom_col()'}
