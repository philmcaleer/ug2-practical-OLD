...
The main way we teach data-wrangling skills is by using the Wickham Six verbs. These are part of the `tidyverse` package which we introduced to you in Level 1. We will look at some of the basics again here but try to look back at last year's exercises to see how we used these verbs. The Wickham Six are: 
