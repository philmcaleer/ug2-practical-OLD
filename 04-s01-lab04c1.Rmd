...
This tells us that the probability of finding someone 150cm or smaller in our class is **p = `r pnorm(150, 170, 7, lower.tail = TRUE)`** or **`r round(pnorm(150, 170, 7, lower.tail = TRUE)*100, 2)`%**. This is a very small probability and suggests that it is pretty unlikely to find someone of 150cm in our class. This is mainly because of how small the standard deviation of our distribution is. Think back to what we said earlier about narrow standard deviations round the mean!  
