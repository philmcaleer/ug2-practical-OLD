...
2. `n` tells you the number of blocks in which the corresponding number of face trials appeared, e.g. in 231 blocks there were 15 face trials. (Remember this is sampled data so your values may be different!). 
