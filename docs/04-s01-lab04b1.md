...
```
##  [1] "HEADS" "TAILS" "HEADS" "TAILS" "HEADS" "TAILS" "TAILS" "HEADS"
##  [9] "HEADS" "HEADS"
```
...
```
##  int [1:10000] 4 6 6 6 5 3 5 4 5 4 ...
```
...
Note that as the possible number of heads in 10 flips are all related to one another, then summing up all the probabilities of the different number of heads will give you a total of 1. You can use this informaiton to start asking questions such as what would be the probability of obtaining 2 or less Heads in 10 flips?  Well, if the probability of no heads in this distribution is **0.0013**, and the probability of 1 heads is **0.0108**, and the probability of 2 heads is **0.0418**, then the probability of 2 or less Heads in this distribution is simply the sum of these values: **0.0539**
