...
* You should probably use a Spearman correlation for the correlation between Pitch and Dispersion because as the scales are very different although measured both in (Hz)
